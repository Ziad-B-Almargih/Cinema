                    ...
                    <a href="{{ route('movies.show', $movie) }}"
                       class="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="my-2 text-sm font-bold dark:text-gray-200">{{ $movie->schedule->date }}</p>
                            <p class="my-2 text-sm font-bold dark:text-gray-200">{{ Carbon::make($movie->schedule->start_time)->format('h:i A') }}</p>
                            <span
